...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 100px; top: 312px; position: absolute" Text="Cancel" OnClick="btnCancel_Click" />
        <p>
            &nbsp;</p>
        <asp:Button ID="btnFind" runat="server" OnClick="btnFind_Click" style="z-index: 1; left: 207px; top: 310px; position: absolute" Text="Find" />
    </form>
</body>
</html>
